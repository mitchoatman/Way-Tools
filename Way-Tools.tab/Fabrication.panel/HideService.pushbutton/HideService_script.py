...
for Item in pipe_collector:
    servicename = get_parameter_value_by_name(Item, 'Fabrication Service Name')
...
servicelist = forms.SelectFromList.show(set(SrvcList), multiselect=True, button_name='Hide Service(s)')
